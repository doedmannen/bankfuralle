...
-- Dumpar data för tabell bankfuralle.accounts: ~4 rows (ungefär)
...
INSERT INTO `accounts` (`id`, `owner_id`, `number`, `type`, `name`) VALUES
	...
	(11, 1, '96589658965896', 'SALARY', 'nytt konto'),
	(13, 1, '89974499448064', 'SAVING', 'fefe'),
...
-- Dumpar data för tabell bankfuralle.monthly_transactions: ~2 rows (ungefär)
...
) ENGINE=InnoDB AUTO_INCREMENT=283 DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci;

-- Dumpar data för tabell bankfuralle.transactions: ~37 rows (ungefär)
...
INSERT INTO `transactions` (`id`, `from_account`, `to_account`, `amount`, `message`, `time_of_transaction`, `status`) VALUES
	...
	(280, 8, 13, 120.00, '123test', '2019-03-25 12:55:53', 'DONE'),
