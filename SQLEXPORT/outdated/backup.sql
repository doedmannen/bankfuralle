...
) ENGINE=InnoDB AUTO_INCREMENT=358 DEFAULT CHARSET=utf8 COLLATE=utf8_swedish_ci;

-- Dumpar data för tabell bankfuralle.transactions: ~23 rows (ungefär)
...
INSERT INTO `transactions` (`id`, `from_account`, `to_account`, `amount`, `message_withdrawal`, `message_deposit`, `time_of_transaction`, `status`) VALUES
	...
	(357, NULL, NULL, 25000.00, 'no message needed', 'lön', '2019-03-29 08:51:24', 'DONE');
